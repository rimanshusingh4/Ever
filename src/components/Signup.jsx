...
const Signup = ()=>{
  ...
  return (
    <div className='mt-20 mb-10 w-1/3 border-8 border-orange-700 hover:bg-gray-600 rounded-full  text-center'>
        <Input onChange={(e)=> setUserData({...userData, name:e.target.value})} label="name" type='text' name='name' placeholder='Enter Full Name' className='w-3/5 border  border-gray-600 p-5 mt-3 rounded-lg'/>
